...
public class SpinnerAdapterProvince extends BaseAdapter {
    private final List<ProvinceBean.DataBean> data;
     ...
     * @param layoutId 布局Id
     */
    public SpinnerAdapterProvince(Context context, List<ProvinceBean.DataBean> data, int layoutId) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        txt_name.setText(data.get(position).getProvinceName()+"");
