...
import com.aladdin.hxe.app.MyApplication;
...
public class CommonUtils {
    ...
    //创建跳转方法
     public static void startActivity(Activity activity,Class goTo){
         ...
         //跳转动画
         activity.overridePendingTransition(com.aladdin.hxe.R.anim.xin_right, com.aladdin.hxe.R.anim.xout_left);

     }
    //返回
    public static void finishActivity(Activity activity) {
        activity.finish();
        activity.overridePendingTransition(com.aladdin.hxe.R.anim.xin_left, com.aladdin.hxe.R.anim.xout_right);
    }
