...
public class InquireCancelOrderFragment extends Fragment implements XRecyclerView.LoadingListener , View.OnClickListener{
    ...
    private void initData() {
        ...
        myAdapter.buttonSetOnclick(new InquireAllOrderAdapter.ButtonInterface() {
            ...
            public void onclick(View view, final int position) {
               TextView tv_fistfoodName = (TextView) view.findViewById(R.id.tv_fistfoodName);
    ...
    public void requestData(final Boolean isRefrsh, String Time) {
        ...
        RequestManager.postJson()
                .setUrl(Url.findordercancel0427)
                .addParams("token", token)
                .addParams("createTime", time)
                .addParams("size", String.valueOf(size))
                .addParams("page", String.valueOf(page))
                .builder().onUI()
                .setCallback(new IRequestBeanListener<InquireCancelOrderBean>() {
                    @Override
                    public void onSuccess(InquireCancelOrderBean baen) {
     ...
     * 刷新Adapter
     */
    private void builderAdapter(ArrayList<InquireCancelOrderBean.DataBean.RowsBean> listAll, Boolean isRefrsh) {
