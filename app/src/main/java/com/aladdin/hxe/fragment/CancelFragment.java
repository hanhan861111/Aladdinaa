...
import com.aladdin.hxe.adapter.CancelAdapter;
...
public class CancelFragment extends Fragment implements XRecyclerView.LoadingListener {
    private View view;
    private int page = 1;
    private int size = 20;
    ...
    private ArrayList<CancelOrderBean.DataBean.RowsBean> listAll = new ArrayList<>();
    private CancelAdapter myAdapter = new CancelAdapter(getActivity());
    private int total;
    private boolean isChecked = false;
    private List<CancelOrderBean.DataBean.RowsBean> rows;
    private CancelOrderBean.DataBean.RowsBean rowsBean;
    private String message;

    @Nullable
    @Override
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        view = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_cancel, null, false);
        return view;
    }
    ...
    private void initData() {
        ...
        myAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(final View view, int position) {
                ...
                rowsBean = rows.get(position);
                final List<CancelOrderBean.DataBean.RowsBean.OrdersProductsBean> ordersProducts = rows.get(position).getOrdersProducts();
                lv_orderproducts.setAdapter(new CommonAdapter<CancelOrderBean.DataBean.RowsBean.OrdersProductsBean>(getActivity(), R.layout.orderinfo_item, ordersProducts) {
                    @Override
                    protected void convert(ViewHolder viewHolder, CancelOrderBean.DataBean.RowsBean.OrdersProductsBean item, int position) {
...
//        mRecyclerView.setLimitNumberToCallLoadMore(2);
    ...
    public void requestData(final Boolean isRefrsh) {
        ...
        RequestManager.postJson()
                ...
                .builder().onUI()
                .setCallback(new IRequestBeanListener<CancelOrderBean>() {
                    @Override
                    public void onSuccess(CancelOrderBean baen) {
     ...
     * 刷新Adapter
     */
    private void builderAdapter(ArrayList<CancelOrderBean.DataBean.RowsBean> listAll, Boolean isRefrsh) {
