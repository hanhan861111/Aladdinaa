...
public class InquireAllOrderFragment extends Fragment implements XRecyclerView.LoadingListener, View.OnClickListener {
    private View view;
    private int page = 1;
    private int size = 20;
    private XRecyclerView mRecyclerView;
    private ArrayList<InquireAllOrderBean.DataBean.RowsBean> listAll = new ArrayList<>();
    private InquireAllOrderAdapter myAdapter = new InquireAllOrderAdapter(getActivity());
    private int total;
    private String time;
    private ListView lv_orderproducts;
    private List<InquireAllOrderBean.DataBean.RowsBean> rows;
    ...
    private InquireAllOrderBean.DataBean.RowsBean rowsBean;
    ...
    public void requestData(final Boolean isRefrsh, String Time) {
        ...
        RequestManager.postJson()
                .setUrl(Url.appordersr0427)
                .addParams("token", token)
                .addParams("createTime", time)
                .addParams("size", String.valueOf(size))
                .addParams("page", String.valueOf(page))
                .builder().onUI()
                .setCallback(new IRequestBeanListener<InquireAllOrderBean>() {
                    @Override
                    public void onSuccess(InquireAllOrderBean baen) {
     ...
     * 刷新Adapter
     */
    private void builderAdapter(ArrayList<InquireAllOrderBean.DataBean.RowsBean> listAll, Boolean isRefrsh) {
