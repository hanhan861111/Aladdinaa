...
import com.aladdin.hxe.adapter.InquireFinishOrderAdapter;
...
public class InquireFinishOrderFragment extends Fragment implements XRecyclerView.LoadingListener, View.OnClickListener {
    private View view;
    private int page = 1;
    private int size = 20;
    private XRecyclerView mRecyclerView;
    private ArrayList<InquireFinishOrderBean.DataBean.RowsBean> listAll = new ArrayList<>();
    private InquireFinishOrderAdapter myAdapter = new InquireFinishOrderAdapter(getActivity());
    private int total;
    private String time;
    private ListView lv_orderproducts;
    private List<InquireFinishOrderBean.DataBean.RowsBean> rows;
    ...
    private InquireFinishOrderBean.DataBean.RowsBean rowsBean;
     ...
     */
        ...
        RequestManager.postJson()
                .setUrl(Url.findorderimpl0427)
                .addParams("token", token)
                .addParams("createTime", time)
                .addParams("size", String.valueOf(size))
                .addParams("page", String.valueOf(page))
                .builder().onUI()
                .setCallback(new IRequestBeanListener<InquireFinishOrderBean>() {
                    @Override
                    public void onSuccess(InquireFinishOrderBean baen) {
     ...
     * 刷新Adapter
     */
    private void builderAdapter(ArrayList<InquireFinishOrderBean.DataBean.RowsBean> listAll, Boolean isRefrsh) {
