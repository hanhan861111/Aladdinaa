...
public class AllOrderHolder extends BaseHolder{
    public final TextView tv_orderNum;
    public final TextView tv_orderPrice;
    public final TextView tv_orderTime;
    public final TextView tv_payStatus;
    public AllOrderHolder(View itemView) {
        super(itemView);
        ...
        tv_payStatus = (TextView) itemView.findViewById(R.id.tv_payStatus);
    }
}
